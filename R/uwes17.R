#' Calcula os escores do UWES-17 e suas classificações
#'
#' Calcula os escores médios das três dimensões do UWES-17
...
#'
#' @param df Um data.frame ou tibble contendo os 17 itens
#' do UWES-17. Cada linha representa um respondente e
...
#'
#'   \item{Individual}{
#'   Escores individuais das dimensões do UWES-17 e suas
...
#'
#' @details
#' As dimensões do UWES-17 são calculadas da seguinte forma:
#'
#' \describe{
#'
#'   \item{Vigor}{
#'   Média dos itens 1, 4, 8, 12, 15 e 17.
#'   }
#'
#'   \item{Dedicacao}{
#'   Média dos itens 2, 5, 7, 10 e 13.
#'   }
#'
#'   \item{Absorcao}{
#'   Média dos itens 3, 6, 9, 11, 14 e 16.
#'   }
#'
#'   \item{Engajamento}{
#'   Média de todos os 17 itens.
#'   }
#'
#' }
#'
...
uwes17 <- function(df,
  ...
  calcular_uwes(
    df = df,
    itens_vigor = c(1, 4, 8, 12, 15, 17),
    itens_dedicacao = c(2, 5, 7, 10, 13),
    itens_absorcao = c(3, 6, 9, 11, 14, 16),
    total_itens = 17,
    norma = norma
  )
}
